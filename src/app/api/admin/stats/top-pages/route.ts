...
/** Public top pages. Only current site routes, public featured work, and public field notes. */
export async function GET(request: NextRequest) {
  ...
  for (const r of data) {
    if (!r.path || !r.visitor_id || isExcludedFromStatsReporting(r.path, publicSlugs)) continue
