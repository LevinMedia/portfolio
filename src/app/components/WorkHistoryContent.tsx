...
const WorkHistoryContent: React.FC = () => {
  return (
    <div className="relative">
      {/* Timeline Line */}
      <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-accent/40 via-primary/30 to-secondary/20"></div>
      
      <div className="space-y-8">
        {/* CaptivateIQ */}
        <div className="relative">
          {/* Timeline Node */}
          <div className="absolute left-6 top-[1.875rem] w-4 h-4 bg-accent rounded-full border-4 border-background z-10"></div>
          <div className="absolute left-4 top-[2.3rem] w-16 h-0.5 bg-accent/40"></div>
        ...
        <div className="relative">
          {/* Timeline Node */}
          <div className="absolute left-6 top-[1.875rem] w-4 h-4 bg-secondary rounded-full border-4 border-background z-10"></div>
          <div className="absolute left-4 top-[2.3rem] w-16 h-0.5 bg-secondary/40"></div>
        ...
        <div className="relative">
          {/* Timeline Node */}
          <div className="absolute left-6 top-[1.875rem] w-4 h-4 bg-primary rounded-full border-4 border-background z-10"></div>
          <div className="absolute left-4 top-[2.3rem] w-16 h-0.5 bg-primary/40"></div>
        ...
        <div className="relative">
          {/* Timeline Node */}
          <div className="absolute left-6 top-[1.875rem] w-4 h-4 bg-destructive rounded-full border-4 border-background z-10"></div>
          <div className="absolute left-4 top-[2.3rem] w-16 h-0.5 bg-destructive/40"></div>
        ...
        {/* Footer Actions */}
        <section className="ml-20 pt-4 border-t border-neutral-100/6">
