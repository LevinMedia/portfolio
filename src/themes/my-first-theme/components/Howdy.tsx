...
import ButtonTooltip from '@/app/components/ButtonTooltip';
...
export default function Howdy({
  ...
  return (
    <div
      ...
      style={{ gap: 'calc(var(--grid-major) * 2)' }}
    >
      <div className="w-full sm:w-fit border border-blue-200/15 rounded-none backdrop-blur-sm bg-background p-8 sm:p-12 lg:p-16 xl:p-20">
        <div className="flex flex-col items-start text-left" style={{ gap: 'calc(var(--grid-major) * 1.5)' }}>
          <h1
            className="text-2xl sm:text-5xl font-extrabold tracking-tight text-foreground font-[family-name:var(--font-geist-mono)] flex items-center gap-6"
...
${listItemsHtml}
          ...
          >
            <ul
              className="list-none text-foreground/80 font-[family-name:var(--font-geist-sans)] flex flex-col"
              style={{ gap: 'calc(var(--grid-major) / 2)' }}
            >
          ...
          <div
            ...
            style={{ gap: 'var(--grid-major)', marginTop: 'calc(var(--grid-major) * 0.5)' }}
          >
